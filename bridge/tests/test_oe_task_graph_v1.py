...
def test_oe_milestone_dependency_chain_is_strict() -> None:
    ...
    assert tasks["OE-003D"]["status"] == "DONE"
    assert tasks["OE-003E"]["status"] == "DONE"
    ...
    assert tasks["OE-004D"]["status"] == "DONE"
    assert tasks["OE-004E"]["status"] == "DONE"
    assert tasks["OE-004F"]["status"] == "DONE"
    assert tasks["OE-004"]["status"] == "DONE"
    assert tasks["OE-005A"]["status"] == "DONE"
    assert tasks["OE-005B"]["status"] == "DONE"
    assert tasks["OE-005C"]["status"] == "DONE"
    assert tasks["OE-005D"]["status"] == "DONE"
    assert tasks["OE-005E"]["status"] == "DONE"
    assert tasks["OE-005F"]["status"] == "DONE"
    assert tasks["OE-005"]["status"] == "DONE"
    assert tasks["OE-006A"]["status"] == "DONE"
    assert tasks["OE-006B"]["status"] == "DONE"
    assert tasks["OE-006C"]["status"] == "DONE"
