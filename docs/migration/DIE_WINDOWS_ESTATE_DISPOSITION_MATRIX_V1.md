...
| human-centric Atlas canon (`company/atlas/human-centric/HUMAN_CENTRIC_ATLAS_CANON.md`) | `MIGRATE_SOURCE` | `/srv/die/company/atlas/human-centric/` | Imported through Git history by DIE-103; this path is now canonical. |
