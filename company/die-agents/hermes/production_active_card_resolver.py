...
ACTIONABLE = {
    ...
    "MASTER_VALIDATED": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue Factory v2 postproduction from validated master."),
    "UPSCALE_DECIDED": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue Factory v2 postproduction after upscale decision."),
    "DERIVATIVES_READY": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue Factory v2 postproduction from derivative evidence."),
    "TECHNICAL_QA_PASS": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue Factory v2 postproduction from technical QA pass."),
    "RIGHTS_SIGNAL_PASS_OR_REVIEW": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue only when rights review state permits package readiness."),
    "METADATA_READY": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Continue Factory v2 package readiness from hash-bound metadata."),
    "PACKAGE_READY": ("hermes-operator", "PROD-CONTINUE-POSTPROCESS", "Park the package at Founder QC with exact package hash."),
