...
def prepare(*, snapshot_path: Path, routing_state_path: Path | None = None, output_dir: Path) -> dict[str, Any]:
    ...
    state = None
    if routing_state_path and routing_state_path.is_file():
...
def main(argv: list[str] | None = None) -> int:
    ...
    out = prepare(snapshot_path=snapshot, routing_state_path=routing_state, output_dir=output)
    summary = {
