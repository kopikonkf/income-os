...
DIE_MCP_BASE_URL=https://division01-mcp.aethers.biz.id
DIE_MCP_OAUTH_CLIENT_ID=chatgpt-division01-linux-staging
...
grep -qx 'DIE_MCP_BASE_URL=https://division01-mcp.aethers.biz.id' "$ENV_FILE" || { echo "E_STAGING_BASE_URL_MISMATCH" >&2; exit 2; }
