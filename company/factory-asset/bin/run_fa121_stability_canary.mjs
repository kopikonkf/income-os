...
const requestedPlaywrightEntry = arg('--playwright-entry', process.env.MUXIA_PLAYWRIGHT_ENTRY || path.join(repoRoot, 'company/muxia/node_modules/playwright/index.mjs'));
const fallbackPlaywrightEntry = '/srv/die/company/muxia/node_modules/playwright/index.mjs';
const playwrightEntry = path.resolve(fs.existsSync(requestedPlaywrightEntry) ? requestedPlaywrightEntry : fallbackPlaywrightEntry);
