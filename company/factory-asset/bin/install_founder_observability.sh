...
for unit in die-founder-vnc-cluster-a.service die-founder-vnc-cluster-b.service die-founder-repair-vnc-cluster-a.service die-founder-repair-vnc-cluster-b.service; do
