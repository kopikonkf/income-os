...
def test_visual_rights_detector_prompts_are_subject_agnostic():
    ...
    assert d['watermark']['scoring']=='MAX_RISK_MINUS_CLEAN'
    assert d['source_ip']['scoring']=='MAX_APPLICABLE_RISK_MINUS_CLEAN'
    assert d['source_ip']['applicable_risk_indices_by_asset_type']['ISOLATED_OBJECT']==[1,2]
