...
- Zero provider generations/prompts, zero credential/cookie/token reads, zero challenge bypass, zero spend/account/marketplace/submission/publication actions. Linux validation: 24 focused PASS, 749 Factory PASS, 6 one-canon PASS, validator 11/11 PASS, secret hits 0. Evidence: `company/factory-asset/fixtures/multi-cluster/FA-HOTFIX-cluster-headed-owner-lifecycle.json`; receipt: `company/factory-asset/receipts/FA-HOTFIX-cluster-headed-owner-lifecycle.receipt.json`.
