...
- Validation: focused FA-305 + broker regression `8 passed`; full Factory `645 passed, 1 warning` (PyPDF2 deprecation); one-canon pytest `6 passed`; validator `11/11 PASS`, secret scan 0.
