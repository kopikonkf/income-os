...
async function demandReadModel(dataRoot){
 return {
  mode:'NON_BLOCKING_PRIORITY_OVERLAY',
  object_atlas_validity_effect:'NONE',
  standalone_production_blocking_effect:'NONE',
  telemetry:await buildDemandTelemetry({dataRoot})
 };
}
...
export function createReadModels({repoRoot,dataRoot='/var/lib/die/h01',legacyBase='http://127.0.0.1:8876'}){
 return {
  ...
  async demand(){return demandReadModel(dataRoot)},
