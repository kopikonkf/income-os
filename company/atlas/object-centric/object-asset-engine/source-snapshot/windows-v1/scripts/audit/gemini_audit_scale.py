...
RUN_LOG = pathlib.Path(r"D:\object-asset-engine\reports\audit_scale.log")

GEMINI_MODEL = "gemini-3.5-flash-lite"
BATCH_SIZE = 500  # 500 fits 16k token limit; 1000 truncates at 16k (see test_500_timing.py 30s/500 vs 40s/1000 truncated)
SLEEP_BETWEEN_BATCHES = 30  # seconds (2026-08-26 user request: pantau CPU/RAM, dari 2s → 30s; per-key jadi ~4.2 menit, total ~31 jam untuk 741k)
    ...
    while True:
        ...
        if missing > 0:
            ...
            if missing > len(words) * 0.2:
                miss_file = pathlib.Path(r"D:\object-asset-engine\reports\audit_miss_batches")
